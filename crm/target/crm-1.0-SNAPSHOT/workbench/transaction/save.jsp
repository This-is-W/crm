...
<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control" id="create-activitySrc" value="天山雪莲">
			<input type="hidden" name="activityId" value="3bf146f439e14115a4715c88eafbf577"/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control" id="create-contactsName" value="腾讯">
			<input type="hidden" name="contactsId" value="aa08df27deba4965ac484e0fa9ad4e09"/>
		</div>
	</div>
